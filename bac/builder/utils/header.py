...
class HeaderInfo(object):
    """
    Holds information on sequence and structure derived from PDB header.

    Parameters
    ----------
    pdb_filename : :obj:`str`, optional
        Path to PDB from which to read header
    ...
    def _add_seq_res_line(self, line):
        """
    ...
    def read_pdb_header(self, pdb_filename):
        """
